...
plt.legend()
plt.title('Динамика номинальной среднемесячной ЗП работников в сфере образования РФ за 2000-2023 гг')
plt.xlabel('Год')
...
plt.legend()
plt.title('Динамика номинальной среднемесячной ЗП работников в сфере строительства РФ за 2000-2023 гг')
plt.xlabel('Год')
plt.ylabel('Средняя зарплата')
st.pyplot(fig_2)
...
plt.legend()
plt.title('Динамика номинальной среднемесячной ЗП работников в сфере гостиничного и ресторанного бизнеса РФ за 2000-2023 гг')
plt.xlabel('Год')
plt.ylabel('Средняя зарплата')
st.pyplot(fig_3)

st.write('**Вывод**: В рассмотренных сферах реальная зарплата растет медленнее номинальной зарплаты в связи с тем, что уровень инфляции растет быстрее номинальной зарплаты')